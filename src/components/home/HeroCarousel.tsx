...
const slides: SlideData[] = [
  ...
  // SLIDE 2 — WEARABLES
  {
    ...
    lightGlow: "rgba(14, 165, 233, 0.12)",
  ...
  // SLIDE 3 — FASHION
  {
    ...
    lightGlow: "rgba(99, 102, 241, 0.10)",
  ...
  // SLIDE 4 — HOME & LIVING
  {
    ...
    lightGlow: "rgba(245, 158, 11, 0.10)",
            ...
            <button
              ...
              className={`h-2 rounded-full transition-all duration-500 cursor-pointer ${
                idx === current
                  ...
                  : "w-2 bg-slate-400 hover:bg-slate-600 dark:bg-white/30 dark:hover:bg-white/50"
              }`}
            />
          ))}
        </div>
